 ...
 * @author SonHa
 */
public class SuperServer extends Thread implements MessageCallback, OnDisconnectListener {
            ...
            try {
                ...
                (new Thread() {
                    ...
                    public void run() {
                        ...
                        client.setOnMessageCallback(SuperServer.this);
//                        client.setOnReceiveListener(Server.this);
                        client.setOnDisconnectListener(SuperServer.this);
                        client.start();
                    }
                }).start();
